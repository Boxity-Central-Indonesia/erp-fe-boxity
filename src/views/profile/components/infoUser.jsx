...
export const InfoUser = () => {
  ...
  const [profileData, setProfileData] = useState(null); // Store the fetched profile
  const [isLoading, setIsLoading] = useState(false); // Track the data loading state
    ...
    const fetchProfile = async () => {
      ...
      try {
        ...
        if (status === 200) {
          ...
          // Handle error if API response status is not 200 (optional)
