...
import ModalCreateMaster from './layouts/ModalCreateMaster';
...
function Master() {
            ...
            <Table hoverable>
              ...
              <Table.Body className="divide-y">
                <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <Table.Cell>baharihari49@gmail.com</Table.Cell>
                ...
                <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <Table.Cell>bintangjtobing@gmail.com</Table.Cell>
                  <Table.Cell>Super Admin</Table.Cell>
                  <Table.Cell>
                    <a href="#" className="font-medium text-cyan-600 hover:underline dark:text-cyan-500">
                      Edit
  ...
  return (
    ...
    <ModalCreateMaster openModal={openModal} onToggleModal={toggleOpenModal} />
