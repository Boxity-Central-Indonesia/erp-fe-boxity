...
const TabelComponent = ({data, dataHeading, showHeading, handleEdit, setOpenModal, skeleton })  => {
  ...
  return (
    <section className="bg-gray-100 dark:bg-gray-900 mb-32">
      <h3 className="text-2xl font-semibold mb-3 dark:text-white">{dataHeading && dataHeading[0].heading}</h3>
      <div className="mx-auto">
        <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
          ...
          < TabelHeading toggleOpenModal={dataHeading && dataHeading[0].eventToggleModal} icon={dataHeading && dataHeading[0].icon}
            label={dataHeading && dataHeading[0].label} globalFilter={globalFilter} setGlobalFilter={setGlobalFilter}
            handleClickHeading={dataHeading && dataHeading[0].onclick} showNavHeading={dataHeading && dataHeading[0].showNavHeading}
            activeButton={dataHeading && dataHeading[0].activeButton} dataNavHeading={dataHeading && dataHeading[0].dataNavHeading} />
          </div>
