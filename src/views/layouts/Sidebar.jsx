  ...
  const menuItems = [
    ...
    },
    {
      ...
      subMenu: [
        ...
        { path: "/reports/cash-flow", label: "Laporan Arus Kas" },
        { path: "/reports/ledger", label: "Laporan Buku Besar" },
        { path: "/reports/cash-account", label: "Laporan Kas Besar" },
      ],
    },
    {
      label: "Reports",
      ...
      subMenu: [
        { path: "/reports/sales", label: "Laporan Penjualan" },
        { path: "/reports/purchases", label: "Laporan Pembelian" },
        { path: "/reports/income", label: "Laporan Pendapatan" },
        { path: "/reports/expenditure", label: "Laporan Pengeluaran" },
        { path: "/reports/inventory", label: "Laporan Persediaan Barang" },
        { path: "/reports/leads", label: "Laporan Leads" },
        { path: "/reports/vendor-transactions", label: "Laporan Vendor" },
        { path: "/reports/production", label: "Laporan Produksi" },
      ],
    },
  ];
        ...
        <nav className="mt-5">
          ...
          <ul className="pt-2 mt-2 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
            ...
            <li className="group">
              ...
              >
                ...
                <span className="ms-3">API Documentation</span>
              </a>
            </li>
          </ul>
          <div
          ...
          >
            <div className="flex items-center mb-3">
              <span className="bg-orange-100 text-orange-800 text-xs font-semibold me-2 px-2.5 py-0.5 rounded dark:bg-orange-200 dark:text-orange-900">
                UAT Version 0.0.1
              </span>
            </div>
