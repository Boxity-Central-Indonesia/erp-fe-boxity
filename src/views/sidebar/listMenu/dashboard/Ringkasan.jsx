...
,
        ...
        {
             mainIcon: <div className="bg-blue-200 p-3 rounded-md w-fit h-fit"> 
                            <svg className="w-6 h-6 text-blue-600 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
,
        ...
        {
            mainIcon: <div className="bg-violet-200 p-3 rounded-md w-fit h-fit">
                            <svg className="w-6 h-6 text-violet-600 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
,
        ...
        {
            mainIcon: <div className="bg-green-200 p-3 rounded-md w-fit h-fit">
                            <svg className="w-6 h-6 text-green-600 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
