  ...
  const dataElement = [
    {
      mainIcon:
        data.length > 0 &&
        parseFloat(
          data[0].amount.replace("Rp ", "").replace(".", "").replace(",", "")
        ) < 0 ? (
    ...
    },
    {
      mainIcon:
        data.length > 0 &&
        parseFloat(
          data[1].amount.replace("Rp ", "").replace(".", "").replace(",", "")
        ) < 0 ? (
          <div className="bg-red-200 p-3 rounded-md w-fit h-fit">
            <svg
              className="w-6 h-6 text-red-600 dark:text-white"
    ...
    },
    {
      mainIcon:
        data.length > 0 &&
        parseFloat(
          data[2].amount.replace("Rp ", "").replace(".", "").replace(",", "")
        ) < 0 ? (
          <div className="bg-red-200 p-3 rounded-md w-fit h-fit">
            <svg
              className="w-6 h-6 text-red-600 dark:text-white"
    ...
    },
    {
      mainIcon:
        data.length > 0 &&
        parseFloat(
          data[3].amount.replace("Rp ", "").replace(".", "").replace(",", "")
        ) < 0 ? (
          <div className="bg-red-200 p-3 rounded-md w-fit h-fit">
            <svg
              className="w-6 h-6 text-red-600 dark:text-white"
