...
export const NewOrder = ({ setOpenDrawer }) => {
  ...
  return (
    <>
      <div className="px-5 overflow-y-scroll">
        ...
        <div className={`col-span-2 mt-5 mb-32`}>
          <TabelForProducts
      ...
      <div className="fixed p-5 border w-full bottom-0 flex gap-3 bg-white z-50 ">
        <button
          ...
          className="rounded-md py-3 px-5 border w-fit text-sm"
        >
          Back
        </button>
        <button
          ...
          className="rounded-md text-white py-3 px-5 border w-fit text-sm flex items-center"
        >
          <IconAdd />
          Add new order
        </button>
